        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button
                type="submit"
                className="cursor-pointer px-4 py-2 bg-linear-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition"
              >
                Save Changes
              </button>
            </div>
